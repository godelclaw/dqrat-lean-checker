-- Experimental watched-literals runtime CLI. NOT the certified checker:
-- the soundness theorems cover Main.lean (dqrat-lean); this binary exists
-- for benchmarking and differential testing of the watched runtime layer.
